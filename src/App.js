          ...
          <div className="row">
            <div className="col-md-8 wp1 animated fadeInUp">
              <p>
                ...
                Phasellus ut euismod massa, eu eleifend ipsum.Lorem ipsum dolor
                sit amet, consectetur adipiscing elit. Praesent eget risus vitae
                massa semper aliquam quis mattis quam. Morbi vitae tortor
                tempus, placerat leo et, suscipit lectus. Phasellus ut euismod
                massa, eu eleifend ipsum.
              </p>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                Praesent eget risus vitae massa semper aliquam quis mattis quam.
          ...
          <div className="row">
            ...
            <div className="col-sm-6 wow fadeInRight">
              ...
              <p>
                ...
                purus eu tellus consequat ultricies. Donec feugiat tempor
                turpis, rutrum sagittis mi venenatis at. Sed molestie lorem a
                blandit congue. Ut pellentesque odio quis leo volutpat, vitae
                vulputate felis condimentum.
              </p>
                ...
                <div className="media service-box">
                  ...
                  <div className="media-body">
                    ...
                    <p>
                      ...
                      lectus. Phasellus ut euismod massa, eu eleifend ipsum.
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="row">
                  <div className="col-xs-12">
                    <blockquote>
                      Sontrary to popular belief, Lorem Ipsuis no simply random
                      text. It has roots in a piece of classical Layears old.
                      belief, Lorem Ipsuis not simply
                    </blockquote>
                  </div>
                </div>
                <div className="row">
            ...
            <div className="col-md-4">
              ...
              >
                <div className="row">
                  <div className="col-xs-12">
                    <blockquote>
                      Tontrary to popular belief, Lorem Ipsuis no simply random
                      text. It has roots in a piece of classical Layears old.
                      belief, Lorem Ipsuis not simply
                    </blockquote>
                  </div>
            ...
            <div className="col-md-4">
              ...
              >
                <div className="row">
                  <div className="col-xs-12">
                    <blockquote>
                      Aontrary to popular belief, Lorem Ipsuis no simply random
                      text. It has roots in a piece of classical Layears old.
                      belief, Lorem Ipsuis not simply
                    </blockquote>
                  </div>
